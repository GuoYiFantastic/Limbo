...
// #ifndef LIMBO_ALGORITHMS_COLORING_OPBgen
// #define LIMBO_ALGORITHMS_COLORING_OPBgen
...
#include <limbo/solvers/api/OpbApi.h>
...
/// @class limbo::algorithms::coloring::OPBgen
...
class OPBgen : public Coloring<GraphType>
{
	public:
        /// @nowarn 
        ...
        typedef limbo::solvers::OpbApi<model_type::coefficient_value_type, model_type::variable_value_type> solver_type; 
        /// @endnowarn
        
		/// constructor
        /// @param g graph 
		OPBgen(graph_type const& g) 
			: base_type(g)
		{}
		/// destructor
		virtual ~OPBgen() {}
...
template <typename GraphType>
double OPBgen<GraphType>::coloring()
{
...
template <typename GraphType>
void OPBgen<GraphType>::write_graph_sol(string const& filename, typename OPBgen<GraphType>::model_type const& opt_model, 
        std::vector<typename OPBgen<GraphType>::model_type::variable_type> const& vVertexBit) const
{
