...
// #ifndef LIMBO_ALGORITHMS_COLORING_SJTUColoring
// #define LIMBO_ALGORITHMS_COLORING_SJTUColoring
...
#include <limbo/solvers/api/NeuroSatApi.h>
...
/// @class limbo::algorithms::coloring::SJTUColoring
...
class SJTUColoring : public Coloring<GraphType>
{
	public:
        /// @nowarn 
        ...
        typedef limbo::solvers::NeuroSatApi<model_type::coefficient_value_type, model_type::variable_value_type> solver_type; 
        /// @endnowarn
        
		/// constructor
        /// @param g graph 
		SJTUColoring(graph_type const& g) 
			: base_type(g)
		{}
		/// destructor
		virtual ~SJTUColoring() {}
...
template <typename GraphType>
double SJTUColoring<GraphType>::coloring()
{
	...
	int32_t opt_statue = solver();
// #ifdef DEBUG_SJTUColoring
...
template <typename GraphType>
void SJTUColoring<GraphType>::write_graph_sol(string const& filename, typename SJTUColoring<GraphType>::model_type const& opt_model, 
        std::vector<typename SJTUColoring<GraphType>::model_type::variable_type> const& vVertexBit) const
{
